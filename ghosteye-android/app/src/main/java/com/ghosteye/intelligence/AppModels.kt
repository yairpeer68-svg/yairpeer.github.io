...
data class CaseItem(val id: String, val title: String, val notes: String?, val status: String = "open", val priority: String = "normal", val tags: List<String> = emptyList(), val investigationCount: Int = 0)
