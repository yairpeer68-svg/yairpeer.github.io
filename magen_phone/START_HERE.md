# Magen Phone v4.2 — התחלה מהירה

גרסה זו היא `4.2.0-full-hardening`, ללא Device Owner, ומתאימה ל-Magen VPS v4.2.
...
4. הפלט: `magen-v4.2.0-full-hardening-debug.apk` + קובץ SHA-256.
