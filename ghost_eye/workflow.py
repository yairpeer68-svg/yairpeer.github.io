...
DEFAULT_RECIPES: Dict[str, List[str]] = {
    ...
    "osint": ["emails", "emailauth", "username", "dorks", "github",
              ...
              "sitedossier", "favicmmh3", "anubisjldc", "phishstats", "waybackparams", "wikidata", "commoncrawlmine", "waybacksecrets", "phoneharvest", "extdomains", "otxpulse", "merklemap", "uriblock", "npmsearch", "dockerhub", "cratesio", "rubygems", "packagist", "nuget", "artifacthub", "gitlabsearch", "hackernews", "reddit"],
