...
PIVOT_MODULES: Dict[str, List[str]] = {
    ...
    "ip": ["geoip", "internetdb", "reputation", "rdap",
           ...
           "reverseip", "otxip", "iptoasn", "feodo", "peeringdb", "ipwhois", "dnsbl", "stopforumspam", "ipapinet", "blocklistde", "ipinfo", "ipguide", "greynoise", "ipquery", "freeipapi", "dshield", "ipwhoisapp"],
}
