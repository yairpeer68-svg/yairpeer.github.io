...
PIVOT_MODULES: Dict[str, List[str]] = {
    "domain": ["whois", "dns", "subs", "emails", "related", "whoispivot",
               ...
               "favicmmh3", "anubisjldc", "waybackparams", "wikidata", "commoncrawlmine", "phoneharvest", "extdomains", "otxpulse", "merklemap", "npmsearch", "dockerhub", "cratesio", "rubygems", "packagist", "nuget", "artifacthub", "gitlabsearch", "hackernews", "reddit", "gdelt", "stackexchange", "secedgar", "wikipedia", "codeberg"],
