...
PIVOT_MODULES: Dict[str, List[str]] = {
    "domain": ["whois", "dns", "subs", "emails", "related", "whoispivot",
               ...
               "favicmmh3", "anubisjldc", "waybackparams", "wikidata", "commoncrawlmine", "phoneharvest", "extdomains", "otxpulse", "merklemap", "npmsearch", "dockerhub", "cratesio", "rubygems", "packagist", "nuget", "artifacthub", "gitlabsearch", "hackernews", "reddit", "gdelt", "stackexchange", "secedgar", "wikipedia", "codeberg", "pdnsmnemonic", "swheritage", "columbus", "crtsh", "bitbucket", "sourcegraph", "dohcloudflare", "dohgoogle", "openphish", "bgpviewsearch", "ripedb", "gleif", "githuborg", "leakix", "sucuri", "xposeddomain", "crtshorg", "tranco", "otxmalware", "otxurls", "digitalside", "dnsseccaa", "dnslytics", "lookalike", "spfdmarc", "certissuers", "mxintel", "nsintel", "txtsaas", "spfvendors", "wildcarddns", "htdns", "dkimscan", "soaintel", "danetlsa", "pagelinks", "phisharmy", "httpsrr", "srvscan", "domainptr", "mozillaobs", "stevenblack", "certemails", "entrustct", "mobileapps", "adstxt", "sitemapscan", "humanstxt", "cspdomains", "crossdomain", "idpfinger", "jsassets", "trackers", "preconnects", "wpusers", "feeds", "openapi", "wpstack", "manifest", "cnamemap", "matrixsrv", "nodeinfo", "phishdb", "opensearch", "hostmeta", "tokenhunt", "envexposed", "gitexposed", "waybacktokens", "hagezi", "blocklistproject", "spam404"],
    "email": ["emailfootprint", "breachcheck", "hibpbreach", "gravatar", "emailperm", "emailrep", "leakcheck", "xposedornot"],
    "username": ["usernamescan", "usernamevariants", "username", "githubuser", "gitlabuser", "hnuser", "dockeruser", "reddituser", "npmuser", "githubgists", "devtouser", "githubactivity", "githubkeys", "githuborgs", "stackuser", "githubrepos", "dockerrepos", "codeberguser", "gitlabprojects", "githubsocials", "keybaseuser", "githubemail", "lobsters", "githubgpg", "bitbucketws", "githubfollowers", "githubstars", "cratesuser", "wikipediauser", "hnauthor", "launchpad", "githubwatched", "giteauser", "mastodonlookup", "debiansalsa", "gnomeuser"],
    "ip": ["geoip", "internetdb", "reputation", "rdap",
           "robtex", "bgpview", "ipapi", "cymruasn",
           "reverseip", "otxip", "iptoasn", "feodo", "peeringdb", "ipwhois", "dnsbl", "stopforumspam", "ipapinet", "blocklistde", "ipinfo", "ipguide", "greynoise", "ipquery", "freeipapi", "dshield", "ipwhoisapp", "iplocationnet", "arinrdap", "incolumitas", "ipapiis", "ripeiprdap", "iprdap", "proxycheck", "asnprefixes", "asninfo", "sslbl", "rpki", "binarydefense", "ipsum", "cinsarmy", "firehol", "firehol2", "geolocationdb", "reallyfreegeoip", "tornodes", "vpnapi", "firehol3", "dshieldnet", "talos", "spamhausdrop", "techniknews", "asnupstreams", "greensnow", "emergingthreats", "dbip", "bruteforceblocker", "feodoaggr", "geoiplookup"],
}
