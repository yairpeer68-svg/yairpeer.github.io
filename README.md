...
- **378 modules** across 19 categories
...
- **555 automated tests** (unit + smoke + behavioural + engine + intelligence + integration), CI on
...
- **All-module smoke test** — runs `run()` for every one of the 378 modules
...
**555 tests** pass in ~11s. A single **verification gate** runs the whole thing:
