...
- **483 modules** across 19 categories
...
- **688 automated tests** (unit + smoke + behavioural + engine + intelligence + integration), CI on
...
- **All-module smoke test** — runs `run()` for every one of the 483 modules
