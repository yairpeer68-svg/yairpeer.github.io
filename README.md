...
- **403 modules** across 19 categories
...
- **588 automated tests** (unit + smoke + behavioural + engine + intelligence + integration), CI on
...
- **All-module smoke test** — runs `run()` for every one of the 403 modules
