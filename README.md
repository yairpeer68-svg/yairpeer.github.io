...
- **376 modules** across 19 categories
...
- **552 automated tests** (unit + smoke + behavioural + engine + intelligence + integration), CI on
...
- **All-module smoke test** — runs `run()` for every one of the 376 modules
...
**552 tests** pass in ~11s. A single **verification gate** runs the whole thing:
