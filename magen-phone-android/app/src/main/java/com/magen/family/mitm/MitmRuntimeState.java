...
public final class MitmRuntimeState {
    ...
    public static void intercepted(){intercepted.incrementAndGet();}
    public static void tunneled(){tunneled.incrementAndGet();}
    public static void blocked(){blocked.incrementAndGet();}
    public static void certIssued(){certIssued.incrementAndGet();}
